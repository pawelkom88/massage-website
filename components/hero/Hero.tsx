  ...
  return (
    <section className="lg:mt-24 mt-8 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 className="text-4xl lg:text-5xl leading-[1.20] lg:leading-[1.40] uppercase">
            Professional{" "}
          ...
          <div className="mt-7 grid gap-3 w-full sm:inline-flex">
            <a
              className="text-center bg-primary-clr hover:bg-secondary-clr border border-transparent text-base lg:text-lg text-white font-medium rounded-md transition py-3 px-4"
              href="#">
              Book a massage now
            </a>
            <a
              className="text-center text-primary-clr bg-accent-clr hover:bg-transparent border-2 border-accent-clr text-base lg:text-lg font-medium rounded-md transition py-3 px-4"
              href="#">
