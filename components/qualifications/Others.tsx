...
const CourseItem = ({ children }: { children: React.ReactNode }) => (
  <dt className="w-full text-lg font-medium flex items-center gap-2">
    <svg className="flex-shrink-0" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" id="diploma">
      <path
        fill="#444"
...
const Others = () => {
  return (
    <div className="max-w-7xl mx-auto my-12">
      <h2 className="text-center text-heading2 mt-4">Other</h2>
      <br />
      <br />
      <dl className="lg:w-1/2 -my-3 space-y-3">
        <CourseItem>
          Kinesio Taping for Sports & Massage Therapist, Teach Therapy, Newport
        </CourseItem>
        <CourseItem>Hot Stone Therapy - Certificate in Stroud College</CourseItem>
        <CourseItem>Holistic Facials, Teach Therapy, Newport</CourseItem>
        <CourseItem>Seated Acupressure Massage - HandsOn, Cheltenham</CourseItem>
        <CourseItem>Infant Massage Instructor Course, Teach Therapy, Newport</CourseItem>
        <CourseItem>Reiki - Level 2</CourseItem>
      </dl>
    </div>
  );
};
