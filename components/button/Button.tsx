...
export const ButtonType: ButtonStyles = {
  primary:
    "text-center hover:text-secondary-clr bg-primary-clr hover:bg-transparent border border-2 border-primary-clr text-base text-white font-bold rounded-md transition py-3 px-4",
  secondary:
